...
function main() {
    ...
    var ulc = new Color(255,0,255,255); // upper left corner color: red
    var urc = new Color(0,255,255,255); // upper right corner color: green
    var llc = new Color(0,255,255,255); // lower left corner color: blue
