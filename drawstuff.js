...
function main() {
    ...
    var ulc = new Color(255,0,255,200); // upper left corner color: red
    var urc = new Color(0,255,255,150); // upper right corner color: green
    var llc = new Color(255,255,0,100); // lower left corner color: blue
    var lrc = new Color(255,192,203,255); // lower right corner color: black
